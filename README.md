...
|--------|----|---------|-------------|
| WestMarch Système | `westmarch` | 2.1.9 | Socle core — sessions, party, chat, combat, audio |
...
| Midi Range Fix | `midi-range-fix` | 1.5.1 | Corrige la portée midi-qol pour les grands tokens |
