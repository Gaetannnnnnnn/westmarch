...
|--------|----|---------|-------------|
| WestMarch Système | `westmarch` | 2.2.2 | Socle core — sessions, party, chat, combat, audio |
...
| Midi Range Fix | `midi-range-fix` | 1.5.5 | Corrige la portée midi-qol pour les grands tokens |
| Toolkit | `toolkit` | 1.2.4 | Outils GM — polymorph, boutiques MEJ, export fiches |
