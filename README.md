...
|--------|----|---------|-------------|
| WestMarch Système | `westmarch` | 2.2.5 | Socle core — sessions, party, chat, combat, audio |
...
| Midi Range Fix | `midi-range-fix` | 1.5.8 | Corrige la portée midi-qol pour les grands tokens |
