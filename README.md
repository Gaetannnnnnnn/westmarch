...
|--------|----|---------|-------------|
| WestMarch Système | `westmarch` | 2.2.3 | Socle core — sessions, party, chat, combat, audio |
...
| Midi Range Fix | `midi-range-fix` | 1.5.6 | Corrige la portée midi-qol pour les grands tokens |
| Toolkit | `toolkit` | 1.2.5 | Outils GM — polymorph, boutiques MEJ, export fiches |
