...
|--------|----|---------|-------------|
| WestMarch Système | `westmarch` | 2.0.9 | Socle core — sessions, party, chat, combat, audio |
...
| Midi Range Fix | `midi-range-fix` | 1.3.9 | Corrige la portée midi-qol pour les grands tokens |
