...
|--------|----|---------|-------------|
| WestMarch Système | `westmarch` | 2.2.1 | Socle core — sessions, party, chat, combat, audio |
...
| Carnet d'Expéditions | `carnet` | 1.3.8 | Onglets Carnet & Expéditions sur la fiche PJ |
| Map Ouvert Systèmes | `carte-expeditions` | 1.0.2 | Gestion fog of war par personnage/groupe |
| Midi Range Fix | `midi-range-fix` | 1.5.2 | Corrige la portée midi-qol pour les grands tokens |
| Toolkit | `toolkit` | 1.2.3 | Outils GM — polymorph, boutiques MEJ, export fiches |
