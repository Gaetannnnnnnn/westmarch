...
| Midi Range Fix | `midi-range-fix` | 1.3.6 | Corrige la portée midi-qol pour les grands tokens |
| Toolkit | `toolkit` | 1.1.5 | Outils GM — polymorph, boutiques MEJ, export fiches |
| Tutoriel | `tutoriel` | 1.2.6 | Guide interactif pour les joueurs et le GM |
