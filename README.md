...
| Midi Range Fix | `midi-range-fix` | 1.4.9 | Corrige la portée midi-qol pour les grands tokens |
| Toolkit | `toolkit` | 1.2.1 | Outils GM — polymorph, boutiques MEJ, export fiches |
