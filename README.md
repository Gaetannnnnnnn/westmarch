...
|--------|----|---------|-------------|
| WestMarch Système | `westmarch` | 2.1.8 | Socle core — sessions, party, chat, combat, audio |
...
| Carnet d'Expéditions | `carnet` | 1.3.7 | Onglets Carnet & Expéditions sur la fiche PJ |
| Map Ouvert Systèmes | `carte-expeditions` | 1.0.2 | Gestion fog of war par personnage/groupe |
| Midi Range Fix | `midi-range-fix` | 1.4.8 | Corrige la portée midi-qol pour les grands tokens |
| Toolkit | `toolkit` | 1.2.0 | Outils GM — polymorph, boutiques MEJ, export fiches |
