...
| Midi Range Fix | `midi-range-fix` | 1.4.7 | Corrige la portée midi-qol pour les grands tokens |
| Toolkit | `toolkit` | 1.1.9 | Outils GM — polymorph, boutiques MEJ, export fiches |
