...
|--------|----|---------|-------------|
| WestMarch Système | `westmarch` | 2.2.4 | Socle core — sessions, party, chat, combat, audio |
...
| Midi Range Fix | `midi-range-fix` | 1.5.7 | Corrige la portée midi-qol pour les grands tokens |
